...
const s: Record<string, React.CSSProperties> = {
  ...
  input: { width: '100%', height: 50, borderRadius: 12, padding: '0 14px', fontSize: 15, color: 'var(--text-normal)', outline: 'none', background: '#fff', boxSizing: 'border-box', transition: 'border 150ms ease, box-shadow 150ms ease' },
  textarea: { width: '100%', borderRadius: 12, padding: '12px 14px', fontSize: 14, color: 'var(--text-normal)', outline: 'none', background: '#fff', boxSizing: 'border-box', resize: 'none', lineHeight: 1.6, transition: 'border 150ms ease, box-shadow 150ms ease' },
